...
public class ArrayStack<T> implements StackADT<T>
{
    ...
    public static void main(String args[]){
    	ArrayStack testArray = new ArrayStack(100);
	    ...
	    System.out.println("current size of the stack is "+ testArray.size());
	    System.out.println("peek operation returns: " + testArray.peek());
